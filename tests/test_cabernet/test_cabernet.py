...
import xarray as xr
from pca_analysis.exp_manager.manager import Cabernet, PinotNoir, Shiraz
...
def cab():
    ...
    return cab.assign(child=xr.DataTree(xr.Dataset()))


@pytest.fixture
def pn_input_data(cab: Cabernet):
    return cab["input_data"]


@pytest.fixture
def shz_input_data(pn_input_data: Cabernet):
    return pn_input_data["input_data"]
